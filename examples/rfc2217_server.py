...
""")
    ...
    logging.info("RFC 2217 TCP/IP to serial redirector - press CTRL+C to quit")
    ...
    while True:
        if ser is None:
            ...
            try:
                ...
                if displayNextFailedConnectionAttempt:
                    logging.error("Opening port failed: {}".format(ser.name))
                    displayNextFailedConnectionAttempt = False
